...
public class BackPain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView gifImageView8 = findViewById(R.id.imageView8);
        ...
        Glide.with(this)
                .asGif()
                .load(R.raw.swimming)
                .into(new DrawableImageViewTarget(gifImageView8){
                    @Override
                    public void onResourceReady(@NonNull Drawable resource, @NonNull Transition<? super Drawable> transition){
                        super.onResourceReady(resource, transition);
                        // Access the GifDrawable for additional settings if needed
